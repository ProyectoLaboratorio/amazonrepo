# Generated by Django 4.2.4 on 2024-01-23 18:04
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('userVerifyMode', models.CharField(blank=True, choices=[('cardOrFace', 'Tarjeta o cara'), ('cardOrfaceOrPw', 'Tarjeta, cara o clave'), ('cardOrPw', 'Tarjeta o clave'), ('card', 'Tarjeta'), ('cardOrFace', 'Cara o clave'), ('face', 'Cara')], max_length=30, verbose_name='Tipo de verificación')),
                ...
                ('card', models.CharField(blank=True, max_length=20, verbose_name='Tarjeta')),
